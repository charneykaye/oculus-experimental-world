...
#ifndef OVR_ExperimentalWorld_h
#define OVR_ExperimentalWorld_h
...
#include "Lib/Platform/Platform_Default.h"
#include "Lib/Render/Render_Device.h"
#include "Lib/Render/Render_XmlSceneLoader.h"
#include "Lib/Platform/Gamepad.h"
#include "Lib/Util/OptionMenu.h"
#include "Lib/Util/RenderProfiler.h"
...
//
//  ExperimentalWorldApp::OnStartup - This function will initialize the SDK, creating the Hmd
//									and delegating to CalculateHmdValues to initialize it.
//
//  ExperimentalWorldApp::OnIdle    - Here we poll SensorFusion for orientation, apply it
...
//-------------------------------------------------------------------------------------
// ***** ExperimentalWorld Application class

// An instance of this class is created on application startup (main/WinMain).
// It then works as follows:
//  - Graphics and HMD setup is done ExperimentalWorldApp::OnStartup(). Much of
...
class ExperimentalWorldApp : public Application
{
public:
