...
Filename    :   ExperimentalWorld_Scene.cpp
...
void ExperimentalWorldApp::InitMainFilePath()
{
    ...
    const char* baseDirectories[] = { "",
                                      contentBase.ToCStr(),
                                          ...
                                          #define STR1(x) #x
                                          #define STR(x)  STR1(x)
                                          STR(SHRDIR) "/ExperimentalWorld/Assets/Tuscany/"
                                      #endif
                                      };
    String newPath;
...
void ExperimentalWorldApp::PopulateScene(const char *fileName)
{
    ClearScene();
	...
	// Anna: ExperimentalWorld/Assets/Tuscany/Tuscany_OculusCube.tga file needs to be added
...
void ExperimentalWorldApp::PopulatePreloadScene()
{
...
void ExperimentalWorldApp::ClearScene()
{
    MainScene.Clear();
    LoadingScene.Clear();
...
void ExperimentalWorldApp::RenderAnimatedBlocks(ovrEyeType eye, double appTime)
{
...
void ExperimentalWorldApp::RenderGrid(ovrEyeType eye, Recti renderViewport)
{
...
void ExperimentalWorldApp::RenderControllers(ovrEyeType eye)
{
    if (!HasInputState)
        return;
